...
Github Flavored Markdown (GFM) is based on [Markdown Syntax Guide](http://daringfireball.net/projects/markdown/syntax) with some overwriting as described at [Github Flavored Markdown](http://github.github.com/github-flavored-markdown/)

Below guide is based on markdownguide.org
...
<dl>
  <dt>More Features</dt>
  <dd>The new version of this project has a lot more features!</dd>
  <dt>Easier to use</dt>
  <dd>We've changed the app UI so that it's much easier to use!</dd>
</dl>
